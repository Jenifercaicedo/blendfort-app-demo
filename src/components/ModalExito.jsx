  ...
  return (
    ...
    >
      ...
      <div className="relative min-h-full flex items-start md:items-center justify-center px-4 py-8 md:px-6 md:py-10">
        <div className="relative bg-white w-full max-w-sm rounded-[2.4rem] md:rounded-[3rem] shadow-[0_30px_100px_rgba(0,0,0,0.25)] border border-black/5 overflow-hidden animate-in zoom-in-95 duration-300 my-2 md:my-4">
          <div className="bg-blendfort-fondo/60 border-b border-black/5 px-6 md:px-8 pt-6 md:pt-7 pb-5">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-black/5 shadow-sm">
              <div className="w-1.5 h-1.5 rounded-full bg-blendfort-naranja animate-pulse" />
          ...
          <div className="p-7 md:p-10 text-center">
            ...
            >
              {tipoNormalizado === "error" ? (
                <svg
                  className={`w-9 h-9 ${config.iconText}`}
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth="3"
                ...
                <svg
                  className={`w-9 h-9 ${config.iconText} animate-in zoom-in-50 delay-100 duration-500`}
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth="3"
            ...
            <div className="mt-6 space-y-2">
              ...
              <p className="text-lg md:text-xl font-black uppercase tracking-tight text-black leading-tight">
                {mensaje}
              </p>
            </div>
