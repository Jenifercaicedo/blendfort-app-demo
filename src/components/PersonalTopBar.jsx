    ...
    <div className="flex justify-between items-center p-5 md:p-6 border-b border-black/5 bg-blendfort-fondo/30">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          type="button"
          className={`md:hidden flex items-center gap-3 px-5 py-2.5 rounded-2xl bg-white border transition-all duration-300 active:scale-95 group shadow-sm hover:border-blendfort-naranja ${
